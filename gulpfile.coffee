  ...
  gulp.task 'build:' + platform, ->
    ...
    nw = new NwBuilder(
      ...
      macPlist:
        ...
        CFBundleIdentifier: 'com.sytten.messengerfordesktop'
    )
...
gulp.task 'pack:osx64', ['sign:osx64'], ->
  ...
  shelljs.rm '-f', './dist/Messenger_osx64_V150.dmg' # appdmg fails if the dmg already exists
  ...
  gulp.src []
    .pipe require('gulp-appdmg')
      ...
      target: './dist/Messenger_osx64_V150.dmg'
